...
const getStatusBadge = (status: string) => {
  switch (status) {
    case "Pending":  return <Badge status="warning" text={<Text type="warning" strong>Chờ duyệt</Text>} />;
    case "Approved": return <Badge status="success" text={<Text type="success" strong>Đã duyệt</Text>} />;
    case "Rejected": return <Badge status="error"   text={<Text type="danger"  strong>Từ chối</Text>} />;
