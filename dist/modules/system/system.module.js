...
exports.SystemModule = SystemModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([ngay_le_entity_1.NgayLe, nhat_ky_he_thong_entity_1.NhatKyHeThong])],
        controllers: [system_controller_1.SystemController],
        providers: [system_service_1.SystemService, audit_subscriber_1.AuditSubscriber],
        exports: [typeorm_1.TypeOrmModule, system_service_1.SystemService],
    })
], SystemModule);
